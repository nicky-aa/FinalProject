...
import com.example.finalproject.MainAdapter
...
class LearningFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        mRecyclerView.adapter = getActivity()?.let { MainAdapter(items, it) }
        mRecyclerView.addItemDecoration( DividerItemDecoration( getActivity(), DividerItemDecoration.VERTICAL))
